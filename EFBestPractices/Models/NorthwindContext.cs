...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        {
            modelBuilder.Entity<Customers>().ToTable("Customer", "dbo");
            ...
            //ignore a property.
            modelBuilder.Entity<Customers>().Ignore(x => x.Fax);

            //set the max length.
            modelBuilder.Entity<Customers>().Property(x => x.ContactName).HasMaxLength(50);


            // More control (one to many relationship)
